...
public class BKWebSocketServer {
    ...
    func startListening() throws {
        let parameters =  NWParameters(tls: try tlsOptions())
...
//        let certData = Data(base64Encoded: pemCert
//                                .replacingOccurrences(of: "-----BEGIN CERTIFICATE-----", with: "")
//                                .replacingOccurrences(of: "-----END CERTIFICATE-----", with: "")
//                                .replacingOccurrences(of: "\n", with: ""))
//        guard let certData = certData,
//            let certificate = SecCertificateCreateWithData(nil, certData as NSData) else {
...
//        guard status == errSecSuccess else { throw "Could not create identity" }
